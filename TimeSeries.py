...
os.chdir(r"C:\Users\Dinesh Kaarthik\TS\Automation")
pwd = os.getcwd()
...
def Regression(data):
    ...
    #modify date according to your dataset; Train : 2017-2018
    Train=data[(data.Year>=2015)&(data.Year<2019)] 
    #modify date according to your dataset; Test : 2019
    ...
    X = np.array(Train[["ID", "Variable_1"]]) 
    ...
    X_test=np.array(Test[["ID", "Variable_1"]]) 
